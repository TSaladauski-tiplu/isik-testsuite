...
Feature: POST einer Medikationsverabreichung (@MedicationAdministration-Create)
  ...
  Scenario: POST einer Medikationsverabreichung
    ...
    When TGR send POST request to "http://fhirserver/MedicationAdministration" with body "!{file('src/test/resources/features/Stufe3/Medikation/fixtures/MedicationAdministration-Create-Fixture.json')}"
