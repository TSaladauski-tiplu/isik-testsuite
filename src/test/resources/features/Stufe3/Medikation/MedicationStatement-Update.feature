...
Feature: Update einer MedicationStatement-Ressource (@MedicationStatement-Update)
  ...
  Scenario: Update einer MedicationStatement-Ressource
    ...
    When TGR send PUT request to "http://fhirserver/MedicationStatement/${data.medicationstatement-update-id}" with body "!{file('src/test/resources/features/Stufe3/Medikation/fixtures/MedicationStatement-Update-Fixture.json')}"
