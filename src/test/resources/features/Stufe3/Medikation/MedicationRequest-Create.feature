...
Feature: POST einer Medikationsverordnung (@MedicationRequest-Create)
  ...
  Scenario: POST einer Medikationsverordnung
    ...
    When TGR send POST request to "http://fhirserver/MedicationRequest" with body "!{file('src/test/resources/features/Stufe3/Medikation/fixtures/MedicationRequest-Create-Fixture.json')}"
