...
Feature: Update Medikationsliste (@List-Update)
  ...
  Scenario: UPDATE einer List-Ressource
    ...
    And TGR send PUT request to "http://fhirserver/List/${data.list-update-id}" with body "!{file('src/test/resources/features/Stufe3/Medikation/fixtures/List-Update-Fixture.json')}"
