...
Feature: Update einer Medikationsverordnung (@MedicationRequest-Update)
  ...
  Scenario: Update einer Medikationsverordnung
    ...
    When TGR send PUT request to "http://fhirserver/MedicationRequest/${data.medicationrequest-update-id}" with body "!{file('src/test/resources/features/Stufe3/Medikation/fixtures/MedicationRequest-Update-Fixture.json')}"
