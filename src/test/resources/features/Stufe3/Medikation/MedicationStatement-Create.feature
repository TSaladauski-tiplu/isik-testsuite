...
Feature: POST einer MedicationStatement-Ressource (@MedicationStatement-Create)
  ...
  Scenario: POST einer MedicationStatement-Ressource
    ...
    When TGR send POST request to "http://fhirserver/MedicationStatement" with body "!{file('src/test/resources/features/Stufe3/Medikation/fixtures/MedicationStatement-Create-Fixture.json')}"
