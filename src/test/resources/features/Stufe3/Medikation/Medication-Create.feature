...
Feature: POST einer Medication-Ressource (@Medication-Create)
  ...
  Scenario: POST einer Medication-Ressource
    ...
    When TGR send POST request to "http://fhirserver/Medication" with body "!{file('src/test/resources/features/Stufe3/Medikation/fixtures/Medication-Create-Fixture.json')}"
