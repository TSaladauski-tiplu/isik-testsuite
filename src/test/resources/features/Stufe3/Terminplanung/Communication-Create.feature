...
Feature: POST einer Communication-Ressource (@Communication-Create)
  ...
  Scenario: POST einer Communication-Ressource
    ...
    And TGR send POST request to "http://fhirserver/Communication" with body "!{file('src/test/resources/features/Stufe3/Terminplanung/fixtures/Communication-Create-Fixture.json')}"
