...
Feature: Buchung eines Termins anhand der Kalender-Referenz (@Appointment-Book-By-Schedule)
  ...
  Scenario: Vorbedingung
    ...
    """
      ...
      - Ein freier Terminblock mit Startzeit 1.1.2027 09:00 und Endzeit 1.1.2027 20:00 muss zuvor manuell im Kalender aus dem Testfall Schedule-Read angelegt worden sein
  ...
  Scenario: Buchung eines Termins anhand der Kalender-Referenz
    ...
    And TGR send POST request to "http://fhirserver/Appointment/$book" with body "!{file('src/test/resources/features/Stufe3/Terminplanung/fixtures/Appointment-Appointment-Book-By-Schedule-Parameters-Fixture.json')}"
