...
Feature: POST Binary-Ressource (@Binary-Create)
  ...
  Scenario: POST einer Binary-Ressource
    ...
    And TGR send POST request to "http://fhirserver/Binary" with body "!{file('src/test/resources/features/Stufe3/Terminplanung/fixtures/Binary-Binary-Create-Fixture.json')}"
